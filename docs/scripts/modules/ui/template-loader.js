...
class TemplateLoader {
    constructor() {
        ...
        this.templatePaths = {
            ...
            'simple-layout': 'layouts/simple-layout',
            ...
            'sub-category-screen': 'pages/sub-category-screen',
            'word-screen': 'pages/word-screen',
            'search-results-screen': 'pages/search-results-screen',
            'hiragana-screen': 'pages/hiragana-screen',
            'katakana-screen': 'pages/katakana-screen',
            'dakuten-screen': 'pages/dakuten-screen',
            'youon-screen': 'pages/youon-screen',

            // 문법 페이지들
            'group1-verb': 'pages/grammar/group1-verb',
            'group2-verb': 'pages/grammar/group2-verb',
            'group3-verb': 'pages/grammar/group3-verb',
            'i-adjective': 'pages/grammar/i-adjective',
            'na-adjective': 'pages/grammar/na-adjective',
            'noun-conjugation': 'pages/grammar/noun-conjugation',
            'noun-forms': 'pages/grammar/noun-forms',
            'particle-study': 'pages/grammar/particle-study',

            // 게임 페이지들
            'sentence-completion': 'pages/games/sentence-completion',
    ...
    async loadTemplate(templateName) {
        ...
        try {
            // 새로운 폴더 구조에서 경로 찾기
            const templatePath = this.templatePaths[templateName] || templateName;
            const response = await fetch(`${this.basePath}${templatePath}.html`);
            ...
            console.log(`Template loaded: ${templateName} from ${templatePath}`);
            return templateHTML;
